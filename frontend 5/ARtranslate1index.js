...
import { Camera, Search, Image as ImageIcon, Upload, Plus, Volume2, Star, ArrowLeft } from 'lucide-react-native'; // For icons
...
export default function TranslateScreen() {
  ...
  const handleLanguagePress = () => {
    navigation.navigate('ChooseLanguageIndexCopy');
  };
      ...
      <View style={styles.screenBackground}>
        ...
        <View style={[styles.imageContainer, { minHeight: screenData.height * (isLandscape ? 0.6 : 0.7) }]}>
          {selectedImage ? (
            ...
            // If no image is selected, display a plain background color (no upload box or text)
        ...
        <View style={[styles.bottomContainer, { paddingHorizontal: isTablet ? 40 : 20 }]}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 4, gap: 12 }}>
            {/* English Button */}
            <TouchableOpacity style={{ backgroundColor: '#18191C', borderRadius: 16, paddingVertical: 12, paddingHorizontal: 24, width: 120, height: 50, alignItems: 'center', justifyContent: 'center' }} onPress={handleLanguagePress}>
              <Text style={{ color: '#fff', fontSize: 20, fontWeight: '500' }}>{sourceLanguage}</Text>
            </TouchableOpacity>
            {/* Swap Button */}
            ...
            {/* Hindi Button */}
            <TouchableOpacity style={{ backgroundColor: '#18191C', borderRadius: 16, paddingVertical: 12, paddingHorizontal: 24, width: 120, height: 50, alignItems: 'center', justifyContent: 'center' }} onPress={handleLanguagePress}>
              <Text style={{ color: '#fff', fontSize: 20, fontWeight: '500' }}>{targetLanguage}</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        {isBottomSheetVisible && (
          ...
          >
            ...
            <View style={{ flexDirection: 'column', gap: 28, width: '100%' }}>
              {/* All text content removed from popup */}
            </View>
