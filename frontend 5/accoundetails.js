      ...
      <View style={styles.profileSection}>
        <View style={styles.profileInfo}>
          ...
          <View style={styles.userInfo}>
            <Text style={styles.userName}>Blair Overt</Text>
            <Text style={styles.userEmail}>blairovert@gmail.com</Text>
          </View>
        </View>
      ...
      <View style={styles.voiceAuthContainer}>
        <View style={styles.voiceAuthHeader}>
          ...
          <Toggle
            ...
            onToggle={() => setVoiceAuthEnabled(previousState => !previousState)}
          />
        </View>
