...
const CombinedScreen = () => {
  ...
  const handleLoginSignUp = async () => {
    ...
    try {
      // Try register first
      let result = await register(email, password, 'device_fingerprint_placeholder', 'zkp_proof_placeholder');
      if (result.status === 'success') {
        ...
        // Try login
        result = await login(email, password, 'device_fingerprint_placeholder', 'zkp_proof_placeholder');
